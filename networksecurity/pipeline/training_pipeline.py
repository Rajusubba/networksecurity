...
class TrainingPipeline:
    ...
    def sync_atifact_dir_to_s3(self):
        try:
    ...
    #sync saved model dir to s3 bucket
    def sync_saved_model_dir_to_s3(self):
        try:
            logging.info("Syncing saved model directory to S3...")
            # Add your logic for syncing saved model directory to S3 here
